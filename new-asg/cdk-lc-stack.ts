...
export class CdkLcStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const vpc = ec2.Vpc.fromLookup(this, 'lan-cicd-existing-vpc', {
      ...
      vpcName: 'CdkInfraStack/lan-cicd-vpc'
    });
    ...
    const secondTargetGroup = secondListener.addTargets('lan-ami-test-new-target-group', {  
      port: 8080,
    ...
    cdk.Tags.of(secondTargetGroup).add("Name", "lan-alb-second-tg");
